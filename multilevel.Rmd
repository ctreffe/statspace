...
-   $\hat{\epsilon}_i$ der geschätzte *Fehler*, also der Unterschiedung zwischen unserem geschätzten Wert der Lesefertigkeit auf Grundlage von $x_i$ und der *tatsächlichen*, gemessenen Lesefertigkeit.
